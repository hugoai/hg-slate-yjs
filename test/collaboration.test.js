...
const tests = [
    ...
    [
        ...
        [createLine([createText('')]), createLine([createText('Hello collaborator!')])],
    ],
    [
    ...
    [
        ...
        [
            createLine([
                Text.create({
                    leaves: [{ text: 'Hello', marks: [{ type: 'strong' }] }, { text: ' ' }],
                }),
            ]),
            createLine([
                Text.create({ leaves: [{ text: 'collaborator!', marks: [{ type: 'em' }] }] }),
            ]),
        ],
    ...
    [
        ...
        [
            createLine([Text.create({ leaves: [{ text: 'first', marks: [{ type: 'em' }] }] })]),
            createLine([
    ...
    [
        ...
        [createLine([createText('first')], { test: '1234' }), createLine([createText('second')])],
        [TestEditor.makeSetNodes([0], { test: '4567' })],
        [createLine([createText('first')], { test: '4567' }), createLine([createText('second')])],
    ],
    [
        'Split an existing paragraph',
        [createLine([createText('Hello collaborator!')])],
        [TestEditor.makeSplitNodes({ path: [0, 0], offset: 6 })],
        [createLine([createText('Hello ')]), createLine([createText('collaborator!')])],
    ],
    [
    ...
    [
        ...
        [createLine([createText('ijkl')]), createLine([createText('abcd')], { test: '1234' })],
    ],
    [
        'Insert node, then insert second node that affects path to the first node',
        [createLine([createLine([createText('abc')]), createLine([createText('def')])])],
        [
...
const getSlateDocAsJSON = (editor) => editor.slateDoc.document.nodes.toArray().map(nodeToJSON);

// Returns sync document converted to slate format as JSON.
const getSyncDocAsJSON = (editor) => toSlateDoc(editor.syncDoc).toJSON();
