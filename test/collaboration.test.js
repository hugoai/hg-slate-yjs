...
const tests = [
  [
    ...
    [
      TestEditor.makeInsertText('Hello ', { path: List([0, 0]), offset: 0 }),
      TestEditor.makeInsertText('collaborator', { path: List([0, 0]), offset: 6, }),
      TestEditor.makeInsertText('!', { path: List([0, 0]), offset: 18 }),
    ],
  ...
  [
    ...
    [createLine([createText('Hello collaborator!')])],
    [
      TestEditor.makeRemoveCharacters(7, { path: List([0, 0]), offset: 11 }),
      TestEditor.makeRemoveCharacters(6, { path: List([0, 0]), offset: 5 }),
    ],
  ...
  [
    ...
    [createLine([createText('Hello collaborator!')])],
    [TestEditor.makeSplitNodes({ path: List([0, 0]), offset: 6 })],
    [
      createLine([createText('Hello ')]),
      createLine([createText('collaborator!')]),
    ],
  ...
  [
    ...
    [
      TestEditor.makeInsertText('ghi ', { path: List([0, 0]), offset: 4 }),
      TestEditor.makeRemoveCharacters(2, { path: List([0, 0]), offset: 1 }),
      TestEditor.makeInsertText('jkl ', { path: List([0, 0]), offset: 6 }),
      TestEditor.makeRemoveCharacters(1, { path: List([0, 0]), offset: 11 }),
      TestEditor.makeInsertText(' mno', { path: List([0, 0]), offset: 12 }),
    ],
  ...
  [
    ...
    [
      TestEditor.makeRemoveNodes([0]),
      TestEditor.makeInsertText(' ijkl ', { path: List([0, 0]), offset: 2 }),
    ],
  ...
  [
    ...
    [
      TestEditor.makeInsertText(' mnop ', { path: List([0, 0]), offset: 2 }),
      TestEditor.makeRemoveNodes([1]),
      TestEditor.makeInsertText(' qrst ', { path: List([1, 0]), offset: 2 }),
  ...
  [
    ...
    [createLine([createText('abcd')])],
    [
      TestEditor.makeInsertText(' efgh ', { path: List([0, 0]), offset: 2 }),
  ...
  [
    ...
    [TestEditor.makeRemoveCharacters(5, { path: List([0, 0]), offset: 4 })],
    [createLine([createText('abc ijklm')])],
    [TestEditor.makeRemoveCharacters(6, { path: List([0, 0]), offset: 1 })],
  ...
  [
    ...
    [TestEditor.makeRemoveCharacters(3, { path: List([0, 0]), offset: 2 })],
    [createLine([createText('abfghijklmnopqrst')])],
    [TestEditor.makeRemoveCharacters(8, { path: List([0, 0]), offset: 5 })],
    [createLine([createText('abfghqrst')])],
    [TestEditor.makeRemoveCharacters(7, { path: List([0, 0]), offset: 1 })],
